...
|---|---------|--------|------------|--------|
| 01 | [🩺 Diabetes Risk Prediction](#-01-diabetes-risk-prediction) | Healthcare | Classification, Feature Engineering | ✅ Complete |
| 02 | [🎮 Game Addiction Detector](#-02-game-addiction-detector) | Behavioral Analytics | Classification, Pattern Analysis | ✅ Complete |
| 03 | *Coming Soon* | — | — | 🔜 |
...
## 🔬 ML Workflow (Applied in Every Project)
...
git clone https://github.com/artist-hks/Machine-Learning-Projects.git
...
- [x] Healthcare ML — Diabetes Risk Prediction
- [x] Behavioral ML — Game Addiction Detection
...
<div align="center">
  <sub>Built with ❤️ and lots of <code>model.fit()</code> calls by <a href="https://github.com/artist-hks">Hemant Sharma</a></sub>
</div>
